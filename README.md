...
3. budget.py. In this task, I created a budget app for categories of products and services (food, clothes etc.). The user can deposit, withdraw, transfer funds and create an old-school-themed spend chart.
